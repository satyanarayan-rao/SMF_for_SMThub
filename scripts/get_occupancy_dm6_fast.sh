...
curl -JL "https://api.genome.ucsc.edu/getData/track?hubUrl=https://usegalaxy.org/api/datasets/f9cad7b01a4721350cd23f89ab8eed41/display?to_ext=txt;genome=mm10;track=fp_and_mvec;chrom=${chrom};start=${start};end=${end}" -o ${annotation}.json
min_size=1000
